...
이 소설에서 O은 상징적으로 반복적으로 등장합니다. \n
주인공 박만도는 한쪽 O을 잃고, \n
남은 OO으로 아들을 감싸 안으려는 장면이 인상적입니다.

여기서 OO은 삶의 고통과 끈질긴 생명력, \n
부성애를 상징합니다. \n
“O로 내 목을 감아야 될 끼다.”라는 대사처럼, \n
OO은 단순한 신체 부위를 넘어 감정과 \n
의지의 매개체로 그려집니다.
...
좋아하는 사람을 본적이 없다!!
    ...
    },
    {
        ...
        "end_hour": 20,
        "label": "오후 6시",
        "question": """갈갈갈... (대신 [브랜드][용도][명칭] 다 맞춰야 함. \n
8글자)""",
        "answer": "닌자휴대용블랜더",
        "prize": "신상 블렌더! 남은 과일 갈아보자!!"
    },
    {
        "start_hour": 20,
        "end_hour": 22,
        "label": "오후 8시",
        "question": """강아지꺼 뺏은거 같아, \n
4월 25일, [브랜드][명칭], 6글자""",
        "answer": "잔스포츠가방",
        "prize": "귀요미 가방!!"
    },
    {
        ...
        "end_hour": 24,
        "label": "오후 10시",
        "question": """내일 필요한 거지... 활활 타라~,
        맛나게ㅆ... 5글자""",
        "answer": "마시멜로우",
        "prize": """그렇지 캠프파이어와 마시멜로우여!!! \n
생일 축하해 울소혜!"""
    }
]
...
<div style='background-color:#f8f9fa; border-left:4px solid #ff6b6b; padding:12px 16px; border-radius:4px; margin:12px 0;'>
  <p style='color:#333; font-size:16px; font-weight:500; margin:0;'>⏰ 정해진 시간(오전 11시, 오후 2시/4시/6시
  /8시/10시)에만 문제가 오픈됩니다.</p>
  <p style='color:#666; font-size:14px; margin-top:8px; margin-bottom:0;'>제한 시간 내에 맞추지 못하면
  선물은 출제자(성동구 사랑꾼)의 몫입니다</p>
</div>
""", unsafe_allow_html=True)
